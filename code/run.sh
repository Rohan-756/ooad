...
# Compile
echo "🔨 Compiling..."
javac -cp "$SQLITE_JAR" -d "$OUT_DIR" $JAVA_FILES
...
echo "Class-Path: lib/sqlite-jdbc.jar" >> "$MANIFEST_FILE"
echo "" >> "$MANIFEST_FILE"
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
java -cp "$SCRIPT_DIR/$JAR_NAME:$SQLITE_JAR:$LIB_DIR/slf4j-api.jar:$LIB_DIR/slf4j-simple.jar" "$MAIN_CLASS"
